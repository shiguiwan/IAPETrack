...
cfg.MODEL.FUSION = edict() ####新增
cfg.MODEL.FUSION.NHEADS = 8
cfg.MODEL.FUSION.DROPOUT = 0.1
cfg.MODEL.FUSION.DIM_FEEDFORWARD = 2048
cfg.MODEL.FUSION.ACTIVATION = 'prelu'
cfg.MODEL.FUSION.NUM_PATTERNS = 0
cfg.MODEL.FUSION.HIDDEN_DIM = 256
